...
//
// Pure header, no FFmpeg; plugins/capture_rtsp_multi/tests/test_url_credentials.cpp
// covers it. core/src/Redactor.cpp uses redact_text for every log line and event.
